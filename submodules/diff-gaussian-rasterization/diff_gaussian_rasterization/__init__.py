            ...
            try:
                if raster_settings.f_count is not None:
                    ...
                    (
                        ...
                        imgBuffer,
                        important_score,
                    ) = _C.mw_score_gaussians(*args)
                elif (raster_settings.safeguard_gs_topk is not None) and (
                    raster_settings.safeguard_gs_score_function & 0xF0 == 0
                ):
                    args += (
                        raster_settings.safeguard_gs_topk,
                        raster_settings.safeguard_gs_score_function,
                    ...
                    (
                        ...
                        imgBuffer,
                        important_score,
                    ) = _C.topk_gaussians(*args)
                elif (raster_settings.safeguard_gs_topk is not None) and (
                    raster_settings.safeguard_gs_score_function & 0xF0 >= 0
                ):  # SE EJECUTA ESTA PORQUE LA SCORE ES 0X24 Y 0X24 & 0XF0 = 240 que es > 0
                    args += (
                        raster_settings.safeguard_gs_topk,
                        raster_settings.safeguard_gs_score_function,
